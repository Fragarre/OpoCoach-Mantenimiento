...
def main() -> int:
    p = argparse.ArgumentParser(
        description="Valida que C1-01_58_26 coincide exactamente con el temario esperado y tiene corpus completo."
    )
    ...
    if integrity != "ok" or fk or faltan or sobran or incompletas:
        print("\nRESULTADO: ERROR")
        return 1

    print("\nRESULTADO: OK - temario y corpus completos e íntegros.")
    return 0
