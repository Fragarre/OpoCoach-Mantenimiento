"""
Dry-run acumulativo de integración GEN A1 para ESPECIAL 1, 2 y 4.
...
- sustituye virtualmente ESPECIAL 1, 2 y 4;
- aplica exclusividad secuencial GENERAL 1 -> ESPECIAL 60;
- valida estructura y hash de los tres GEN revisados.
"""
...
def main():
    p = argparse.ArgumentParser(description="Dry-run acumulativo A1 ESPECIAL 1, 2 y 4")
    ...
    print("="*78)
    print("DRY-RUN ACUMULATIVO GEN A1 / ESPECIAL 1 + 2 + 4")
    print("="*78)
    ...
    print("\nGEN ESPECIAL 4 PREVISTO")
    g4 = gens[4]
    for art in g4["articulos"]:
