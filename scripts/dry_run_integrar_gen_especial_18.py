"""
Dry-run acumulativo de integración GEN A1 para ESPECIAL 1, 2, 4, 5 y 18.
...
- sustituye virtualmente ESPECIAL 1, 2, 4, 5 y 18;
- aplica exclusividad secuencial GENERAL 1 -> ESPECIAL 60;
- valida estructura y hash de los cinco GEN revisados.
"""
...
CONFIG = {
    ...
    18: {
        "id": "GEN-A1-ESPECIAL-18",
        "nombre": "GEN - Las formas de actividad administrativa",
        "n": 6,
        "gen": GEN_DIR / "GEN-A1-ESPECIAL-18.json",
        # Ley 40/2015 art. 4 y CE art. 128 alimentan el GEN pero ya están
        # ocupados estructuralmente por temas anteriores.
        "directas": (
            ("Ley 38/2003, de 17 de noviembre, General de Subvenciones", ("2",)),
            ("Ley 7/1985, de 2 de abril, Reguladora de las Bases del Régimen Local", ("85",)),
            ("Ley 9/2017, de 8 de noviembre, de Contratos del Sector Público", ("284",)),
        ),
    },
}
...
def main():
    p = argparse.ArgumentParser(description="Dry-run acumulativo A1 ESPECIAL 1, 2, 4, 5 y 18")
    ...
    print("="*78)
    print("DRY-RUN ACUMULATIVO GEN A1 / ESPECIAL 1 + 2 + 4 + 5 + 18")
    print("="*78)
    ...
    print("\nGEN ESPECIAL 18 PREVISTO")
    g18 = gens[18]
    for art in g18["articulos"]:
